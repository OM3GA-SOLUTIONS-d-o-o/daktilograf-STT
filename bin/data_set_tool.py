...
import progressbar
from daktilograf_stt_training.util.audio import (
    AUDIO_TYPE_OPUS,
    AUDIO_TYPE_PCM,
    AUDIO_TYPE_WAV,
    change_audio_types,
)
from daktilograf_stt_training.util.augmentations import (
    SampleAugmentation,
    apply_sample_augmentations,
    parse_augmentations,
)
from daktilograf_stt_training.util.downloader import SIMPLE_BAR
from daktilograf_stt_training.util.sample_collections import (
    CSVWriter,
    DirectSDBWriter,
    TarWriter,
