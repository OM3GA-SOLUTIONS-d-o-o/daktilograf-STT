...
Usage:
 From within the training/ directory, call this script as a module:
       ...
       $ python3 -m daktilograf_stt_training.util.check_characters "INFILE"
 e.g.  $ python3 -m daktilograf_stt_training.util.check_characters -csv /home/data/french.csv
 e.g.  $ python3 -m daktilograf_stt_training.util.check_characters -csv ../train.csv,../test.csv
 e.g.  $ python3 -m daktilograf_stt_training.util.check_characters -alpha -csv ../train.csv
