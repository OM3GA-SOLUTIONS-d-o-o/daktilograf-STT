...
def main():
    ...
    decoder_pypi_dep = ["daktilograf_stt_ctcdecoder == {}".format(version)]
    ...
    setup(
        name="daktilograf_stt_training",
        version=version,
        description="Training code for Daktilograf STT",
        url="https://github.com/daktilograf-ai/STT",
        author="Daktilograf STT authors",
        license="MPL-2.0",
