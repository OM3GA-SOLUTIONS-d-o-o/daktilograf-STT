...
from daktilograf_stt_ctcdecoder import Scorer, ctc_beam_search_decoder_batch
from daktilograf_stt_training.util.audio import AudioFile
from daktilograf_stt_training.util.config import Config, initialize_globals_from_cli
from daktilograf_stt_training.util.feeding import split_audio_file
from daktilograf_stt_training.util.flags import FLAGS, create_flags
from daktilograf_stt_training.util.logging import (
    create_progressbar,
    log_error,
    log_info,
    log_progress,
...
def transcribe_file(audio_path, tlog_path):
    from daktilograf_stt_training.train import (  # pylint: disable=cyclic-import,import-outside-toplevel
        create_model,
    )
    from daktilograf_stt_training.util.checkpoints import load_graph_for_evaluation
