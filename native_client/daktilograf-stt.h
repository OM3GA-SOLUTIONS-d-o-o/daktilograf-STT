...
/**
 * @brief An object providing an interface to a trained daktilograf STT model.
 *
...
/**
 * @brief Use the daktilograf STT model to convert speech to text.
 *
...
/**
 * @brief Use the daktilograf STT model to convert speech to text and output results
 * including metadata.
 *
 * @param aCtx The ModelState pointer for the model to use.
 * @param aBuffer A 16-bit, mono raw audio signal at the appropriate
...
/**
 * @brief Free a char* string returned by the daktilograf STT API.
 */
STT_EXPORT
