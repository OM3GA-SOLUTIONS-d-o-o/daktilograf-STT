...
// Import only the error code enum definitions from daktilograf-stt.h
...
// things in daktilograf-stt.h. If we add some new construct to daktilograf-stt.h we need
